// copied and adjusted from Zig e252f92b9947e82f2473a37a74d5f9dc278a1c1d
...
pub fn renderMembers(gpa: Allocator, ais: *Ais, tree: Ast, members: []const Ast.Node.Index) Error!void {
...
pub fn renderComments(ais: *Ais, tree: Ast, start: usize, end: usize) Error!bool {
...
pub fn renderExtraNewline(ais: *Ais, tree: Ast, node: Ast.Node.Index) Error!void {
...
pub fn renderContainerDocComments(ais: *Ais, tree: Ast, start_token: Ast.TokenIndex) Error!void {
    const token_tags = tree.tokens.items(.tag);
    var tok = start_token;
...
pub fn writeFixingWhitespace(writer: std.ArrayList(u8).Writer, slice: []const u8) Error!void {
