...
// Good strategy requires not to search through c and d, if removing b
...
// BFS result: [0 2 4 2 1 3 13 15 17 2 2  19 21 3  0  4  0  5  0  6  0  7  0]
...
test "clacRequiredMemory" {
    const alloc = std.testing.allocator;
    const mtree = try initMTree(u32, alloc, &example_tree);
    defer alloc.free(mtree);
    _ = mtree;
    // expected result
    //mtree: [0 2 4 9 1 3 13 15 17 2 2 19 21 3 0 4 0 5 0 6 0 7 0 ]
    //node_indices: [0 2 3 6 7 8 11 12 ]
}
